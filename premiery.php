...
<body>
    ...
    <main role="main">
	<h1>Najnowsze 10 Filmów</h1>
	<?php
	include('server.php');

	$query = $db->query("SELECT id_filmu, tytul, dlugosc, link, rezyser.imie, rezyser.Nazwisko, kategoria.gatunek, premiera FROM filmyy,rezyser,kategoria WHERE rezyser.id_rezysera=filmyy.id_rezysera and kategoria.id_kategori= filmyy.id_kategori ORDER BY premiera DESC");
	$table = array();
	$i=0;
