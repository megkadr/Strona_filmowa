...
<body>
    ...
    <main>
		<form action="ram.php" method="POST">
			<center>
			Aby powiększyć zasobność swojego RAM'u proszę wypełnić pola formularz
			<br>
			<br>
			...
			<br>
			<br>
			<button type="submit" name="money"><b>Zdobądź więcej RAM'u</b></button>
			</center>
		</form>
    </main>
